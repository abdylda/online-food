...
<head>
  <meta charset="UTF-8">
  <title>Плоская форма входа</title>
...
<div class="container">
  <div class="info">
    <h1>Администрация </h1><span>войти в аккаунт</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
    <input type="text" placeholder="Имя пользователья" name="cr_user"/>
    <input type="text" placeholder="Адрес электронной почты"  name="cr_email"/>
   ...
   <input type="submit"  name="submit1" value="Создавать" />
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <p class="message">Не зарегистрирован?<a href="#">Завести аккаунт</a></p>
  </form>
