...
if(isset($_POST['submit'] ))
{
    if(empty($_POST['uname']) ||
		...
		empty($_POST['address']))
		{
			$error = '<div class="alert alert-danger alert-dismissible fade show">
																...
																<strong>Все поля обязательны!</strong>
															</div>';
		}
	else
	{
    ...
    if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
    {
       	$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>неверный адрес электронной почты!</strong>
															</div>';
    }
	...
	elseif(strlen($_POST['phone']) < 10)
	{
		$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>недействительный телефон!</strong>
															</div>';
	}
	elseif(mysqli_num_rows($check_username) > 0)
     {
    	$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Имя пользователя уже существует!</strong>
															</div>';
     }
	elseif(mysqli_num_rows($check_email) > 0)
     {
    	$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>электронная почта уже существует!</strong>
															</div>';
     }
	else{
	...
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrass!</strong> Новый пользователь успешно добавлен.</br></div>';
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li class="nav-label">Авторизоваться</li>
        ...
        <div class="page-wrapper" style="height:1200px;">
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Добавить пользователей</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="uname" class="form-control" placeholder="Имя пользователя">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger" placeholder="Имя">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Электронное письмо</label>
                                                    <input type="text" name="email" class="form-control form-control-danger" placeholder="Электронное письмо">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
										 ...
										 <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control form-control-danger" placeholder="Телефон">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2022 Все права защищены.</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
