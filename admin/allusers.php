            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Все зарегистрированные пользователи</h4>
                             
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Имя пользователля</th>
                                                <th>Имя</th>
                                                <th>Фамилия</th>
                                                <th>Электронный адркс</th>
                                                <th>Телефон</th>
												<th>Адрес</th>
											...
											<?php
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="7"><center>Нет пользовательских данных!</center></td>';
														}
													else
														{				
