            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Все данные меню</h4>
                                <h6 class="card-subtitle">Экспорт данных в копирование, CSV, Excel, PDF и печать</h6>
                                        ...
                                        <tbody>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>Нет данных о тарелке!</center></td>';
														}
													else
														{				
