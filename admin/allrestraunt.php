            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Все хранит данные</h4>
                                <h6 class="card-subtitle">Экспорт данных в копии, CSV, Excel, PDF и печать</h6>
                                        ...
                                        <thead>
                                            <tr>
											 <th>Код</th>
                                                ...
                                                <th>Открытые часы</th>
                                                <th>Закрыто</th>
												<th>Дни открытых дверей</th>
												  <th>Адрес</th>
												  <th>Магазин-Изображение</th>
												  <th>Дата</th>
												   <th>Действие</th>
                                        ...
                                        <tfoot>
                                            <tr>
											 <th>Код</th>
                                                ...
                                                <th>Часы работы</th>
                                                <th>Закрытое время</th>
												<th>Дни открытых дверей</th>
												  <th>Адрес</th>
												  <th>Образ магазинаe</th>
												  <th>Дата</th>
												   <th>	Действие</th>
                                            </tr>
                                        </tfoot>
                                        <tbody>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>Нет Срорес-Данных!</center></td>';
														}
													else
														{				
