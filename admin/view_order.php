...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Просмотр заказов пользователей</h4>
                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
															 <button type="button" class="btn btn-primary">Действовать</button></a>
															 </center>
											 </td>
												...
												<td><strong>Заголовок:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
														<button type="button" class="btn btn-primary">Просмотр сведений о пользователе</button></a>
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['price']; ?>сом</center></td>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" >Отправлять</button></center></td>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																			<td>   <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>В пути!</button></center></td>
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true">Доставленный</button></center></td>
																			<?php 
																			} 
																			?>
																			<?php
            ...
            <!-- footer -->
            <footer class="footer"> © 2022 Все права защищены. <a href="https://colorlib.com"></a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
