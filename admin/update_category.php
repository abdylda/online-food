...
if(isset($_POST['submit'] ))
{
    if(empty($_POST['c_name']))
		{
			$error = '<div class="alert alert-danger alert-dismissible fade show">
																...
																<strong>Поле обязательно!</strong>
															</div>';
		}
	else
	{
	...
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Обновлено!</strong> Успешно.</br></div>';
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Обновить категорию ресторана</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post' >
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="c_name" value="<?php echo $row['c_name'];  ?>" class="form-control" placeholder="Категория">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="dashboard.php" class="btn btn-inverse">Назад</a>
                                    </div>
                                </form>
                            </div>
                        </div>
