									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Записывать</strong>Обновлено.
															</div>';
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Это название</h5> <span class="mail-desc">Вы можете настроить этот шаблон по своему усмотрению</span> <span class="time">9:08 утра</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" value="<?php echo $roww['title'];?>" class="form-control" placeholder="Название блюда">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">О</label>
                                                    <input type="text" name="about" value="<?php echo $roww['slogan'];?>" class="form-control form-control-danger" placeholder="О">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="Сом">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
