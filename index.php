        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Доставка и вывоз заказа</h1>
                    <h5 class="font-white space-xs">Найдите рестораны, специальные предложения и купоны бесплатно</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">я бы хотел поесть....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to eat...."> </div>
                            </div>
                            <button onclick="location.href='restaurants.html'" type="button" class="btn theme-btn btn-lg">Искать еду</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Заказать еду</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Доставка или вывоз</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Популярные блюда месяца</h2>
                    <p class="lead">Самый простой способ к любимой еде</p>
                </div>
                <div class="row">
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">'.$r['price'].' сом</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Заказать сейчас</a> </div>
															</div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Простой трехэтапный заказ</h2>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Выбери ресторан</h3>
                                    <p>Мы предлагаем вам меню из более чем 345 ресторанов с доставкой онлайн.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Самовывоз или доставка</h3>
                                <p>Доставьте еду! И приятного аппетита! Оплата онлайн при самовывозе или доставке</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Оплата наложенным платежом</p>
                    </div>
                </div>
            </div>
        </section>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Минимум 500 сом</div>
																		<div class="mins"><i class="fa fa-motorcycle"></i> 30 минут</div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>
                                    Лучшее приложение для доставки еды</h3>
                                <p>Теперь вы можете приготовить еду практически, где бы вы ни находились, благодаря бесплатному, простому в использовании приложению "Доставка еды и еда на вынос".</p>
