            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Выберите свою любимую еду</a></li>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i>Минимум 1500 сом</a> </li>
                                        <li class="nav-item"> <a class="nav-link" href="#"><i class="fa fa-motorcycle"></i> 30 минут</a> </li>
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>сом</p>
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn theme-btn btn-lg">Проверить</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">ПОПУЛЯРНЫЕ ЗАКАЗЫ Вкусные горячие блюда! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of food/dishes
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" ><?php echo $product['price']; ?>сом</span>
										  <input class="b-r-0" type="text" name="quantity"  style="margin-left:30px;" value="1" size="2" />
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Добавить в корзину" />
										</div>
										</form>
                                    </div>
                                    <!-- end:row -->
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="images/food-picky-logo.png" alt="Footer logo"> </a> <span>Доставка заказа &amp; Выиграть </span> </div>
